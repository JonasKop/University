 ...
 * Author: dali vt17
 */
char *createString(const char *content, int size) {
...
void testInsertSingleElement(){
    ...
    char *key = createString("key1", 4);
    char *value = createString("value1", 6);
...
void testLookupSingleElement(){
    ...
    char *key1 = createString("key1", 4);
    char *value1 = createString("value1", 6);
    char *value2;
...
void testInsertLookupDifferentKeys(){
    ...
    char *key1 = createString("key1", 4);
    char *key2 = createString("key2", 4);
    char *key3 = createString("key3", 4);
    char *value1 = createString("value1", 6);
    char *value2 = createString("value2", 6);
    char *value3 = createString("value3", 6);
...
void testInsertLookupSameKeys(){
    ...
    char *key1 = createString(key, 4);
    char *key2 = createString(key, 4);
    char *key3 = createString(key, 4);
